_pandoc()
{
    ...
    _arguments -s -S \
    ':FILE:_files'\
    '--list-input-formats[list input formats. See -f.]'\
    '--list-output-formats[list output formats. See -t.]'\
    '(-f+ --from=+)'{-r+,--read=+}'[Specify input format.]:FORMAT:(commonmark docbook docx epub haddock html json latex markdown markdown_github markdown_mmd markdown_phpextra markdown_strict mediawiki native odt opml org rst t2t textile twiki)'\
    '(-r+,--read=+)'{-f+,--from=+}'[Specify input format.]:FORMAT:(commonmark docbook docx epub haddock html json latex markdown markdown_github markdown_mmd markdown_phpextra markdown_strict mediawiki native odt opml org rst t2t textile twiki)'\
    '(-t+ --to=+)'{-w+,--write=+}'[Specify output format.]:FORMAT:(asciidoc beamer commonmark context docbook docbook5 docx dokuwiki dzslides epub epub3 fb2 haddock html html5 icml json latex man markdown markdown_github markdown_mmd markdown_phpextra markdown_strict mediawiki native odt opendocument opml org plain revealjs rst rtf s5 slideous slidy tei texinfo textile zimwiki)'\
    '(-w+ --write=+)'{-t+,--to=+}'[Specify output format.]:FORMAT:(asciidoc beamer commonmark context docbook docbook5 docx dokuwiki dzslides epub epub3 fb2 haddock html html5 icml json latex man markdown markdown_github markdown_mmd markdown_phpextra markdown_strict mediawiki native odt opendocument opml org plain revealjs rst rtf s5 slideous slidy tei texinfo textile zimwiki)'\
